...
if __name__ == '__main__':
    single_face_path = r'G:\deeplearning_dataset\widerface_hpfl_yolo_new\single_face'
    path = r'G:\deeplearning_dataset\widerface_hpfl_yolo_new'
    des_path = r'G:\deeplearning_dataset\widerface_hpfl_yolo_new'
    resume(single_face_path,des_path,path=path)
